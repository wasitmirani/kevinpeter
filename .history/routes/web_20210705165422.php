...
Route::middleware(['auth'])->prefix('student')->name('student.')->group(function () {
    Route::name('course')->group(function(){
        ...
        Route::get('course/enroll/form',[App\Http\Controllers\Student\CourseController::class,'enrollmentForm'])->name('.enroll.form');
        Route::post('course/enroll/form',[App\Http\Controllers\Student\CourseController::class,'enrollmentForm'])->name('.enroll.form');
