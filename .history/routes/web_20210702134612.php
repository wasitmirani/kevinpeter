...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::name('teachers')->group(function(){
        ...
        Route::post('teachers/store',[App\Http\Controllers\Admin\CourseController::class,'store'])->name('.store');
        Route::get('teachers/edit/{id}',[App\Http\Controllers\Admin\CourseController::class,'edit'])->name('.edit');
