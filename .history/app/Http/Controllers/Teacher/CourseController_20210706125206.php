...
class CourseController extends Controller
{
    public function index(){
        ...
        $id = $user->id;
            ...
            $courses = Course::with('teachers')->with('category')->where(['teacher_id','=',Auth::user()->id])->get();
    ...
    public function edit($id){
        ...
        return view('admin.teacherpages.courses.create',compact('teachers','course','categories'));
