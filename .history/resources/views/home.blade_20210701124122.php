    ...
    <div class="slider-wrapper">
        <div class="slider-container">
            ...
            <div class="image-mask">
                <img class="" src="http://localhost/kevinpeter/public/frontend/assets/images/banner.jpg" alt="">
            </div>

            <div class="slide active red" data-order="1" data-color="#EE4654" data-img="/assets/images/banner.jpg">

                <div class="fake-bg red"></div>
                <canvas class="canvas" data-image="http://localhost/kevinpeter/public/frontend/assets/images/banner.jpg" width="1908" height="1010"></canvas>
            ...
            <div class="slide blue" data-order="2" data-color="#EE4654" data-img="http://localhost/kevinpeter/public/frontend/assets/images/banner.jpg">
                <div class="fake-bg blue"></div>
                <canvas class="canvas" data-image="http://localhost/kevinpeter/public/frontend/assets/images/banner.jpg"></canvas>
                <div class="slide-content ">
            ...
            <div class="slide green" data-order="3" data-color="#7ffe8e" data-img="http://localhost/kevinpeter/public/frontend/assets/images/banner.jpg">
...
<section class="zips headline" data-sr-id="3" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="row">
...
<section class="about-us headline" data-sr-id="4" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
            ...
            <div class="col-lg-10 m-auto">
                <div class="row about-in">
                    <div class="col-lg-7 one">
                        <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/about-img.jpg" class="img-fluid" alt=""></div>
                    </div>
...
<section class="study dis-flex headline" data-sr-id="5" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="col-lg-10 m-auto">
...
<section class="teacher headline" data-sr-id="6" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="col-lg-12">
            ...
            <div class="teacher-in">
                <div id="teacher">
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/1.jpg" class="img-fluid" alt=""></div>
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <ul class="list-unstyled">
                                        <li><img src="http://localhost/kevinpeter/public/frontend/assets/images/icon1.png" alt="">3 Months Course</li>
                                        <li><img src="http://localhost/kevinpeter/public/frontend/assets/images/icon2.png" alt="">Start From 300$</li>
                                    </ul>
                                </div>
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/2.jpg" class="img-fluid" alt=""></div>
                            <h2 class="heading-two">JOHN DOE <span>Guitar Teacher</span></h2>
                            <p class="para-two">John Doe was born and raised in Olney, MD, and was surrounded by musicians from an early age.</p>
                            <div class="row">
                                <div class="col-lg-7">
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend//assets/images/3.jpg" class="img-fluid" alt=""></div>
                            <h2 class="heading-two">JOHN DOE <span>Guitar Teacher</span></h2>
                            <p class="para-two">John Doe was born and raised in Olney, MD, and was surrounded by musicians from an early age.</p>
                            <div class="row">
                                <div class="col-lg-7">
...
<section class="awards dis-flex headline" data-sr-id="7" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div class="box">
...
<section class="classes headline" data-sr-id="8" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="col-lg-12">
            ...
            <div class="classes-in">
                <div id="classes">
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/icon-1.png" class="img-fluid" alt=""></div>
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/icon-2.png" class="img-fluid" alt=""></div>
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/icon-3.png" class="img-fluid" alt=""></div>
                    ...
                    <div class="item">
                        <div class="box">
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/icon-4.png" class="img-fluid" alt=""></div>
...
<section class="client headline" data-sr-id="9" style="visibility: visible; opacity: 0; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 m-auto">
                ...
                <div id="client">
                    <div class="item">
                        <div class="box">
                            ...
                            <div class="img-box"><img src="http://localhost/kevinpeter/public/frontend/assets/images/client.jpg" class="img-fluid" alt=""></div>
...
<section class="contact headline" data-sr-id="10" style="visibility: visible; opacity: 1; transition: opacity 0.6s cubic-bezier(0.5, 0, 0, 1) 0s;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 ">
                <div class="map">
