					...
					<div class="col-lg-10 m-auto">
						<div class="row about-in">
							<div class="col-lg-7 one">
								<div class="img-box"><img src="/assets/images/about-img.jpg" class="img-fluid" alt=""></div>
							</div>
				...
				<div class="col-lg-12">
					...
					<div class="teacher-in">
						<div id="teacher">
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/1.jpg" class="img-fluid" alt=""></div>
									...
									<div class="row">
										<div class="col-lg-7">
											<ul class="list-unstyled">
												<li><img src="/assets/images/icon1.png" alt="">3 Months Course</li>
												<li><img src="/assets/images/icon2.png" alt="">Start From 300$</li>
											</ul>
										</div>
							...
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/2.jpg" class="img-fluid" alt=""></div>
									<h2 class="heading-two">JOHN DOE <span>Guitar Teacher</span></h2>
									<p class="para-two">John Doe was born and raised in Olney, MD, and was surrounded by musicians from an early age.</p>
									<div class="row">
										<div class="col-lg-7">
							...
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/3.jpg" class="img-fluid" alt=""></div>
									<h2 class="heading-two">JOHN DOE <span>Guitar Teacher</span></h2>
									<p class="para-two">John Doe was born and raised in Olney, MD, and was surrounded by musicians from an early age.</p>
									<div class="row">
										<div class="col-lg-7">
				...
				<div class="col-lg-12">
					...
					<div class="classes-in">
						<div id="classes">
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/icon-1.png" class="img-fluid" alt=""></div>
							...
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/icon-2.png" class="img-fluid" alt=""></div>
							...
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/icon-3.png" class="img-fluid" alt=""></div>
							...
							<div class="item">
								<div class="box">
									<div class="img-box"><img src="/assets/images/icon-4.png" class="img-fluid" alt=""></div>
						...
						<div id="client">
							<div class="item">
								<div class="box">
									...
									<div class="img-box"><img src="/assets/images/client.jpg" class="img-fluid" alt=""></div>
