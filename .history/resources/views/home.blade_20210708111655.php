...
<section class="teacher headline">
    <div class="container">
        <div class="col-lg-12">
            <h2 class="heading-two mb5">Our Course <span>choose our most popular Courses</span></h2>
                ...
                <div id="teacher">
                    ...
                    <div class="item">
                        <div class="box">
                            ...
                            <h2 class="heading-two">{{$course->course_title}}<span>@if(isset($course->category)){{$course->category->category}}@endif</span></h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 float-right dis-flex-end">
                                    ...
                                    <a  class="btn btn-business"   @guest href="{{route('login')}}" @else href="{{route('enroll.form',$course->id)}}" @endguest>Start now</a>
