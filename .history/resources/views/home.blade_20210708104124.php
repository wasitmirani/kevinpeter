                        ...
                        <div class="box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 float-right dis-flex-end">
                                    ...
                                    <a href="" class="btn btn-business" data-bs-toggle="modal"  @guest id="loginNow"  data-bs-target="#loginModal"  @else id="enrollNow" data-bs-target="#enrollModal" @endguest>Start now</a>
