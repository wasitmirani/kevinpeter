                        ...
                        <div class="box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 float-right dis-flex-end">
                                    ...
                                    <a  class="btn btn-business" type="button" data-bs-toggle="modal"  @guest id="loginNow"  data-bs-target="#loginModal"  @else id="enrollNow" data-bs-target="#enrollModal" @endguest>Start now</a>
...
<!-- Teacher -->
<div class="modal fade" @guest id="loginModal" @else id="enrollModal" @endguest tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">@guest Login @else Enroll @endguest</h5>
