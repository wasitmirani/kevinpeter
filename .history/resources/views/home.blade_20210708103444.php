                        ...
                        <div class="box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 float-right dis-flex-end">
                                    @guest
                                    @if (Route::has('login'))
                                    <a href="" class="btn btn-business" id="loginNow"></a>Enroll now</a>
                                    @endif
                                    @if (Route::has('register'))
                                    <a href="" class="btn btn-business" id="registerNow" ></a>start now</a>
                                    @endif
                                    @else
                                    <a href="" class="btn btn-business" id=""></a>Enroll now</a>
                                    @endguest
                                </div>
                            </div>
                        </div>
