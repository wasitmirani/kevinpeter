...
<form class="row g-3" @if(isset($course)) id="editCourseForm"  @else id="addCourseForm" @endif  enctype="multipart/form-data" class="dropzone">
    @csrf
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <select class="form-control" name="category">
            ...
            <option @if(isset($course->category_id) ==  $category->id) selected @endif value="{{$category->id}}">{{$category->name}}</option>
            @endforeach
