                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select">
                                                <option @if(Auth::user()->role_id == '1') Selected @endif value="1">All</option>
                                                <option @if(Auth::user()->role_id == '2') Selected @endif value="2">Admin</option>
                                                <option @if(Auth::user()->role_id == '3') Selected @endif value="3">User</option>
