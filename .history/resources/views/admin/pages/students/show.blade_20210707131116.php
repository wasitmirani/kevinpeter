                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select">
                                                <option @if($student->role_id == '1') selected @endif value="1">Admin</option>
                                                <option @if($student->role_id == '2') selected @endif value="2">Student</option>
                                                <option @if($student->role_id == '3') selected @endif value="3">Teacher</option>
