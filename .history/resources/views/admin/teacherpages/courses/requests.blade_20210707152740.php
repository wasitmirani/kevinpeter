        ...
        <td>
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item status" type="button" data-id="{{$request->id}}" status-data="2">Accept</a>
                  <a class="dropdown-item status" href="button" data-id="{{$request->id}}" status-data="3">Reject</a>
