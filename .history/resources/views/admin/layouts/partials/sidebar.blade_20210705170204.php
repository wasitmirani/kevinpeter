...
<div class="menu">
    ...
    <div class="menu-body">
        ...
        <ul>
          ...
          <li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="{{route('admin.course.list')}}" @php request()->route()->getName()=="admin.course" ? "active" : " " @endphp>List</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="{{route('admin.categories')}}" @php request()->route()->getName()=="admin.categories" ? "active" : " " @endphp> List</a>
                    </li>
                    <li>
                        <a href="{{route('admin.categories.create')}}" @php request()->route()->getName()=="admin.categories" ? "active" : " " @endphp>Add</a>
                    </li>
                </ul>
            </li>
        </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="" @php request()->route()->getName()=="admin.course" ? "active" : " " @endphp>Courses List</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{route('student.course.enroll.form')}}" @php request()->route()->getName()=="admin.course" ? "active" : " " @endphp>Enroll Now</a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{route('admin.course.list')}}" @php request()->route()->getName()=="admin.course" ? "active" : " " @endphp>Courses List</a>
                </li>
                <li>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="" @php  request()->route()->getName()=="admin.students" ? "active" :" " @endphp>List</a>
                </li>
                <li>
                    <a href="order-detail.html">Detail</a>
                </li>
