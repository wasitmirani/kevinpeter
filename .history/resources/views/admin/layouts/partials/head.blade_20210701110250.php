<head>
    ...
    <link href="{{asset('css2.css?family=Poppins:wght@300;400;500;600&display=swap')}}" rel="stylesheet">

    <!-- Bootstrap icons -->
    <link rel="stylesheet" href="{{asset('dist/icons/bootstrap-icons-1.4.0/bootstrap-icons.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('dist/icons/font-awesome/css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('dist/icons/themify-icons')}}" type="text/css">
