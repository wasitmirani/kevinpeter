                ...
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="password" placeholder="Password" autocomplete="off" autocapitalize="off" autocorrect="off" required pattern=".{6,}" class="ControlInput ControlInput--password form-control" placeholder="Confirm Password">
