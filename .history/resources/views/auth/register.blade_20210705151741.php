        ...
        <div class="row">
            ...
            <div class="col-lg-5 dis-flex">
                <ul class="nav nav-tabs" id="tabs-nav" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#tab2" role="tab" aria-controls="profile" aria-selected="false">Student</a>
                    </li>

                  </ul>

                  <div class="" id="tabs-content">
                    <div class="tab-pane fade show active tab-content" id="tab1" role="tabpanel" aria-labelledby="home-tab">Teacher</div>
                    <div class="tab-pane fade tab-content" id="tab2" role="tabpanel" aria-labelledby="profile-tab">Student</div>
