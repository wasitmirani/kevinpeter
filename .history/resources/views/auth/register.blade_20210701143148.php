                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control"  placeholder="Name" class="form-control" @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
                            @error('name')
