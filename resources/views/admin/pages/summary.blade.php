                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="invoice-title">
                                                            <h2>Kevinpeter Music School</h2>
                                                            <div class="invoice-number">Item Id: #{{ $sale->course->id }}</div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6 text-md-right">
                                                                <address>
                                                                    <strong>PlateForm Address</strong><br>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 text-md-right">
                                                                ...
                                                                {{ $sale->created_at,'Y M j | H:i' }}<br><br>
                                                                </address>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-hover table-md">
                                                                ...
                                                                <tr>
                                                                    <td>{{ $sale->course->id }}</td>
                                                                    <td>{{ $sale->course->course_title }}</td>

                                                                    <td class="text-center">
                                                                        @if(!empty($sale->course->price))
                                                                             ${{ $sale->price }}
                                                        ...
                                                        <div class="row mt-4">
                                                            ...
                                                            <div class="col-lg-12 text-right">
                                                                <div class="invoice-detail-item">
                                                                    ...
                                                                    <div class="invoice-detail-value"> $ {{ $sale->price }}</div>
                                                                </div>
                                                                <div class="invoice-detail-item">
