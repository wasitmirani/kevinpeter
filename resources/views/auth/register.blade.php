...
@section('content')
    ...
    <ul class="nav nav-tabs"  id="tabs-nav">
        <li  class="nav-item"><a class="nav-link" href="#tab1" role="tab">Register As Teacher</a></li>
        <li  class="nav-item"><a class="nav-link" href="#tab2" role="tab">Register As Student</a></li>
    ...
    <div  id="tab1" class="tab-content">
        ...
        <div class="row">
            ...
            <div class="col-12 text-center mt-3">
                <a class="btn" href="#">Or Continue With <img src="/assets/images/google.png" class="img-fluid ml-2"></a>
            </div>
        </div>
    </form></div>
